					...
					$(this).find("i.fa").css({
						...
						$(this).animate({
							...
							$(this).siblings("p").css({
							    ...
							    setTimeout(function () {
							        $(".form.contact #message_sent").animate({
                                        opacity:0
							        }, 400, "easeOutCirc", function () {
							            ...
							            $(".form.contact #message_sent").css('display', 'none');
							            $(".form.contact #message_sent").find("i.fa").css('display', 'none');
							            $(".form.contact #message_sent").find("p").remove();
							            processing = false;
							        })
							    }, 3000)
							});
